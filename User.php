...
//    protected $username;
     ...
     * @var string
     *
     * @ORM\Column(type="string", name="email", length=128, nullable=true, unique=false)
     */
    protected $email;
     ...
     * @var string
     *
     * @ORM\Column(type="string", name="email_canonical", length=128, nullable=true, unique=false)
     */
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="aWeekdaysFrom", type="time", nullable=true)
     */
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="aWeekdaysTo", type="time", nullable=true)
     */
    private $aWeekdaysTo;
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="aWeekendFrom", type="time", nullable=true)
     */
     ...
     * @var \DateTime
     *
     * @ORM\Column(name="aWeekendTo", type="time", nullable=true)
     */
    private $aWeekendTo;
